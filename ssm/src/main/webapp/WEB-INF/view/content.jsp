...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="title" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">广告类型</span>
					<select class="form-control" name="caid" id = "txt_search_roleid">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContent.htm" enctype="multipart/from-date">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>图片：</td>
								<td>
								<input type="file" name="file" width="50" height="50">
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>广告连接：</td>
							...
							<tr>
								<td>广告分类：</td>
								<td >
									<select class="form-control" name="caid" id = "caid">
										<option value="0">---请选择---</option>
										<c:forEach items="${calist }" var="c">
						 				<option value="${c.contentcategoryid }">${c.categoryname }</option>
										</c:forEach>
	...
	<div class="modal fade" id="dr" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_dr" method="post" action="dr.htm" enctype="multipart/from-date">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>图片：</td>
								<td>
	...
	var TableInit = function () {
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            } ,
	            {
	                ...
	                sortable:true,
	                formatter:function(value,row,index){
	                	return '<img src="/pic/'+value+'"width="50" height="50"/>';
	                }
	            } ,
	            {
	                field: 'price',
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            title: $("#txt_search_username").val(),
	            caid: $("#txt_search_roleid").val(),
