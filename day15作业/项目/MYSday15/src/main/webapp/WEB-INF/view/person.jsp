...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>存款人爱好：</td>
								<td>
								<input type="checkbox"  name="pLike" value="篮球" aria-required="true" required/>篮球
								<input type="checkbox"  name="pLike" value="足球" aria-required="true" required/>足球
								<input type="checkbox"  name="pLike" value="排球" aria-required="true" required/>排球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款人性别：</td>
								<td>
								<input type="radio"  name="pSex" value="男" aria-required="true" required/>男
								<input type="radio"  name="pSex" value="女" aria-required="true" required/>女
								</td>
							</tr>
							<tr>
								<td>存款金额：</td>
								...
								<td>存款日期：</td>
								<td>
								<input placeholder="存款时间" id="createtime" name="createtime" class="laydate-icon form-control layer-date"
	...
	<!-- 新增银行对话框 -->
	<div class="modal fade" id="modal_bank_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_bank" method="post" action="addBank.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>银行名称：</td>
	...
	<div class="modal fade" id="dr" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_dr" method="post" action="dr.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>要导入的表格：</td>
	...
	<div class="modal fade" id="tu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="bingtu" style="width: 500px;height: 500px">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addbank").click(function(){
	    		$("#form_bank").resetForm();
	    		$('#modal_bank_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_bank_edit').modal('show');
	        });
	    	...
	    	$("#btn_tu").click(function(){
	    		...
	    		var a=echarts.init(document.getElementById("bingtu"));
	    		var sss=new Array();
	    		$.ajax({
	    		    url:"tj.htm",
	    		    type:"post",
	    		    success:function(res){
	    		    	...
	    		    	for (var i = 0; i < arr.length; i++) {
							sss[i]={value:arr[i].num,name:arr[i].bname}
						}
	    		    	option = {
								tooltip : {
									trigger : 'item',
