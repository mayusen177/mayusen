...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>性别：</td>
								<td>
								<input type="radio"  name="sSex" value="男" aria-required="true" required/>男
								<input type="radio"  name="sSex" value="女" aria-required="true" required/>女
								</td>
							</tr>
							<tr>
								<td>生日：</td>
								...
								<td>爱好：</td>
								<td>
								<input type="checkbox"  name="sHobby" value="篮球" aria-required="true" required/>篮球
								<input type="checkbox"  name="sHobby" value="足球" aria-required="true" required/>足球
								<input type="checkbox"  name="sHobby" value="排球" aria-required="true" required/>排球
								</td>
							</tr>
							<tr>
								<td>专业：</td>
	...
	<!-- 新增major对话框 -->
	<div class="modal fade" id="modal_major_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_dr" method="post" action="dr.htm" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_dr_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<!--echarts对话框 -->
	<div class="modal fade" id="tu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="zhutu" style="width: 300px;height: 300px">
					
				</div>
				<div class="modal-header" id="xiantu" style="width: 300px;height: 300px">
					
				</div>
				<div class="modal-header" id="bingtu" style="width: 300px;height: 300px">
	...
	$(function () {
	    ...
	    $("#submit_form_dr_btn").click(function(){
	    	$("#form_dr").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addmajor").click(function(){
	    		...
	    		$('#modal_major_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_major_edit').modal('show');
	        });
	    	...
	    	$("#btn_tu").click(function(){
	    		$('#tu').modal({backdrop: 'static', keyboard: false});
	    		var  a=echarts.init(document.getElementById("zhutu"));
	    		var  b=echarts.init(document.getElementById("xiantu"));
	    		var  c=echarts.init(document.getElementById("bingtu"));
	    		var names=new Array();
	    		var nums=new Array();
	    		var sss=new Array();
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	for (var i = 0; i < arr.length; i++) {
							names[i]=arr[i].mname;
							nums[i]=arr[i].num;
							sss[i]={value:arr[i].num,name:arr[i].mname}
						}
	    		    	option = {
	    					    xAxis: {
	    					        type: 'category',
