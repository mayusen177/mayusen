...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			...
			<div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">时间查询</span>
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="width:500px;height:500px" id="zhutu">
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return row.goodstype.tTypename;
	                }
	            }  , {
	                field: 'createtime',
	                title: '创建时间',
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_zhu").click(function(){
	    		...
	    		var aa=echarts.init(document.getElementById("zhutu"));
	    		var names=new Array();
	    		var nums=new Array();
	    		$.ajax({
	    		    url:"tj.htm",
