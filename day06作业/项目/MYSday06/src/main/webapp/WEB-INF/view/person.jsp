					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>特点名：</td>
								<td>
								<input type="checkbox" name="expressTrait" value="勇敢">勇敢
								<input type="checkbox" name="expressTrait" value="聪明">聪明
								<input type="checkbox" name="expressTrait" value="果断">果断
								<input type="checkbox" name="expressTrait" value="优雅">优雅 
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
								<td>
