        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="scid" id = "txt_search_roleid">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生性别：</td>
								<td>
								<input type="radio"  name="sex" value="男" aria-required="true" required/>男
								<input type="radio"  name="sex" value="女" aria-required="true" required/>女
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
