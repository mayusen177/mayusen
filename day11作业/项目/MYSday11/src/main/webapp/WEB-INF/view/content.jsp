        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">广告标题名 </span>
				...
				<div class="input-group">
					...
					<select class="form-control" name="contentcategoryid" id = "txt_search_roleid">
						...
						<c:forEach items="${calist }" var="ca">
						 	<option value="${ca.contentcategoryid }">${ca.categoryname  }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reserveContent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>广告状态：</td>
								<td>
								<input type="radio" name="status" value="启用" aria-required="true" required/>启用
								<input type="radio" name="status" value="禁用" aria-required="true" required/>禁用
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_zhu").click(function(){
	    		...
	    		var c=echarts.init(document.getElementById("zhutu"));
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	for (var i = 0; i < arr.length; i++) {
								cnames[i]=arr[i].cname;
								nums[i]=arr[i].num;
								sss[i]={value:arr[i].num,name:arr[i].cname};
							}
	    			    	option = {
									tooltip : {
										trigger : 'item',
