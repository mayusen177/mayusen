...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div>
				<div class="input-group">
					<span class="input-group-addon">创建时间区间</span>
					...
					<form id="form_user" method="post" action="reserveGoods.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>状态：</td>
								<td>
								<input type="radio"  name="status" value="上架" aria-required="true" required/>上架
								<input type="radio"  name="status" value="下架" aria-required="true" required/>下架
								</td>
							</tr>
							<tr>
								<td>所属分类：</td>
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	for (var i = 0; i < arr.length; i++) {
							sss[i]={value:arr[i].num,name:arr[i].name}
						}
	    		    	option = {
								tooltip : {
									trigger : 'item',
