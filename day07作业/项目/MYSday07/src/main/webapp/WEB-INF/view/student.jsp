...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>头像：</td>
								<td>
								<img alt="" src="" id="pics" width="50px" height="50px"><br>
	...
	function initEditUser(getSelection){
		...
		$('#pics').prop("src","/pic/"+getSelection.pic);
		$('#pic').val(getSelection.pic);
		$('input[value="'+getSelection.sex+'"]').prop("checked",true);
		$('#time').val(new Date(getSelection.time).Format('yyyy-MM-dd'));
	}
