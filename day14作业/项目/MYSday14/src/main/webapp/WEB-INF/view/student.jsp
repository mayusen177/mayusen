...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>年级：</td>
								<td>
								<select class="form-control" id="grade" name="grade" aria-required="true" required>
									<option value="一年级">一年级</option>
									<option value="二年级">二年级</option>
									<option value="三年级">三年级</option>
								</select>
	...
	<!-- 新增老师对话框 -->
	<div class="modal fade" id="modal_teacher_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_teacher" method="post" action="addTeacher.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入校时间：</td>
								<td>
								<input placeholder="入校时间" id="time" name="entrytime" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addteacher").click(function(){
	    		...
	    		$('#modal_teacher_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_teacher_edit').modal('show');
	        });
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	for (var i = 0; i < arr.length; i++) {
								names[i]=arr[i].tname;
								nums[i]=arr[i].num;
								sss[i]={value:arr[i].num,name:arr[i].tname}
							}
	    			    	option = {
		    					    xAxis: {
		    					        type: 'category',
