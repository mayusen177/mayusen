...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>性别：</td>
								<td>
								<input type="radio" name="sdsex" value="男" aria-required="true" required/>男
								<input type="radio" name="sdsex" value="女" aria-required="true" required/>女
							...
							<tr>
								<td>爱好：</td>
								<td>
								<input type="checkbox"  name="sdhobby" value="篮球"/>篮球
								<input type="checkbox"  name="sdhobby" value="足球"/>足球
								<input type="checkbox"  name="sdhobby" value="排球"/>排球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
								<td>
								<input type="date" name="sdbirth" id="sdbirth" aria-required="true" required/>
								</td>
							</tr>
							<tr>
								<td>专业：</td>
	...
	<!-- 新增专业对话框 -->
	<div class="modal fade" id="major" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="zhutu" style="width: 500px;height: 500px">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addmajor").click(function(){
	    		$("#form_user").resetForm();
	    		$('#major').modal({backdrop: 'static', keyboard: false});
				$('#major').modal('show');
	        });
